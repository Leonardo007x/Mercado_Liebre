      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {cargando ? (
           ...
           <div className="text-center py-20 neumorphic rounded-3xl">
              <p className="text-text-muted">Aún no hay tiendas públicas destacadas. ¡Sé el primero!</p>
           </div>
        ) : (
              ...
              {ejemplos.map((tienda) => (
                 ...
                 >
                    <div className="h-48 overflow-hidden relative">
                       <ImagenInteligente 
                          src={tienda.imagen_banner_url || 'https://via.placeholder.com/800x400'} 
                          alt={tienda.nombre} 
                       ...
                       <div className="absolute bottom-4 left-4 flex items-center gap-3 z-10">
                          ...
                          <div className="text-white">
                             <h3 className="font-bold leading-tight drop-shadow-md">{tienda.nombre}</h3>
                             <p className="text-[10px] opacity-90 flex items-center gap-1"><MapPin size={10} /> {tienda.ciudad}</p>
                          </div>
                       </div>
                    ...
                    <div className="p-6">
                       <p className="text-sm text-text-muted line-clamp-2">{tienda.eslogan || tienda.descripcion || 'Sin descripción disponible.'}</p>
